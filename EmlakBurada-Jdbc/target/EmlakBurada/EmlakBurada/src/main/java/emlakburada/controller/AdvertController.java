...
public class AdvertController {
	...
	public ResponseEntity<AdvertResponse> deleteAdvertByAdvertById(@PathVariable(required = false) int advertId) {
		return new ResponseEntity<>(advertService.deleteAdvertByAdvertById(advertId), HttpStatus.OK);
	}
